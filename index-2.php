...
<div class="offcanvas offcanvas-bottom" id="demo">
    ...
    <div class="offcanvas-body">
       <div class="mb-3"> <label for="iduser" class="form-label">รหัสประจำตัวUser</label>
        <input class="md-4" type="iduser" class="form-control ">
        </div>
        <div class="mb-3">
            <label for="idcreator" class="form-label">รหัสประจำตัวCreator</label><br>
            <input class="md-4" type="idcreator" class="form-control ">
        </div> 
       
         <div class="mb-3">
            <label for="price" class="form-label">ราคา</label>
            <input class="md-4" type="price" class="form-control "><label >บาท</label>
        </div> 
        <div class="mb-3">
        ...
        <div class="mb-3">
          <label for="idcreator" class="form-label">ประเภทสี</label><br>
